  ...
  <div class="animate-fade-in space-y-6 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Peminjaman aktif, terlambat, dan export data transaksi.</p>
      </div>
    ...
    <div v-if="activeTab === 'active'" class="flex items-center gap-3">
    ...
    <div v-if="activeTab === 'active'" class="card p-0 overflow-hidden border-gray-100 shadow-sm bg-white rounded-3xl">
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-50">
            <tr v-if="loading" class="text-center">
              <td colspan="6" class="px-6 py-12 text-gray-400">Memuat data...</td>
            </tr>
    ...
    <!-- Overdue Table -->
    <div v-if="activeTab === 'overdue'" class="card p-0 overflow-hidden border-gray-100 shadow-sm bg-white rounded-3xl">
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tbody class="divide-y divide-red-50">
            <tr v-if="overdueItems.length === 0" class="text-center">
              <td colspan="6" class="px-6 py-12 text-gray-400">
                <div class="text-3xl mb-2">✅</div>
                <p class="font-bold text-gray-900">Tidak ada peminjaman terlambat</p>
              </td>
            </tr>
