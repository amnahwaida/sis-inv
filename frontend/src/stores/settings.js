...
export const useSettingsStore = defineStore('settings', {
  state: () => ({
    settings: {
      ...
      app_theme: 'blue',
      // Default Menu Icons (Heroicons SVG)
  ...
  actions: {
    ...
    async resetBranding() {
      try {
        ...
        const { data } = await api.put('/settings', brandingDefaults)
        if (data.success) {
          // Reset local state to hardcoded defaults
          this.settings = {
            ...this.settings,
            ...brandingDefaults
          }
        ...
        console.error('Failed to reset branding:', e)
        throw e
      }
    }
  }
